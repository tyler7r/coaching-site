    ...
    <div id="contact-container">
      ...
      <div id="contact-details">
        ...
        <div id="contact-message">
          You're so close to upping your Ultimate game. I'm based in Grant Park
          but I'm happy to meet at a park near you! Let's get started!
        </div>
        <div className="contact-detail-container">
          ...
          />
          <a href="mailto:tyler7r@gmail.com" className="contact-detail-info">
            tyler7r@gmail.com
          </a>
        </div>
        <div className="contact-detail-container">
          <img
            ...
            className="contact-detail-image"
          />
          <a href="phone:4049847244" className="contact-detail-info">
            404-984-7244
          </a>
        </div>
      </div>
